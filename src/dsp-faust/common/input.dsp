...
peak_meter_l = _ <: attach(_, an.peak_envelope(peak_meter_fall) : ba.linear2db : vbargraph("v:Input/h:[5]meters/[1][unit:dB]L[symbol:input_peak_L]", -70, 24));
peak_meter_r = _ <: attach(_, an.peak_envelope(peak_meter_fall) : ba.linear2db : vbargraph("v:Input/h:[5]meters/[2][unit:dB]R[symbol:input_peak_R]", -70, 24));
